...
| `cutoverGate` | `metadata/production-cutover-gate.json` | `2026-07-21T11:06:04+00:00` | `NOT_READY_FOR_PRODUCTION_CUTOVER` | blocked=1, notStarted=0, planned=8, productionBacklogItems=0, productionBlockers=0, ready=0, totalGates=9 |
...
| `migrationReadiness` | `metadata/production-migration-readiness.json` | `2026-07-21T11:06:04+00:00` | `NOT_READY_FOR_PRODUCTION_MIGRATION` | blocked=1, notStarted=0, planned=8, ready=0, totalTracks=9 |
...
| `productionBacklog` | `metadata/production-module-backlog.json` | `2026-07-21T10:47:47.562Z` | `PASS` | blocked=0, failBacklog=0, totalItems=0 |
