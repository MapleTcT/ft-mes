...
| `cutoverGate` | `metadata/production-cutover-gate.json` | `2026-07-17T08:30:04+00:00` | `NOT_READY_FOR_PRODUCTION_CUTOVER` | blocked=1, notStarted=0, planned=8, productionBacklogItems=5, productionBlockers=3, ready=0, totalGates=9 |
...
| `migrationReadiness` | `metadata/production-migration-readiness.json` | `2026-07-17T08:30:04+00:00` | `NOT_READY_FOR_PRODUCTION_MIGRATION` | blocked=1, notStarted=0, planned=8, ready=0, totalTracks=9 |
...
| `productionBacklog` | `metadata/production-module-backlog.json` | `2026-07-17T07:55:36Z` | `BLOCKED` | blocked=5, failBacklog=0, totalItems=5 |
