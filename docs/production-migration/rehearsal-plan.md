...
| --- | --- | --- | --- | --- |
| `businessDependencyReadiness` | `metadata/business-dependency-readiness-smoke.json` | `2026-07-10T03:55:34.526Z` | `BLOCKED` | baseUrl=http://100.99.133.43:18080, blocked=2, dependencies=2, ready=0, sshHost=100.99.133.43 |
...
| `coreFlowAcceptance` | `metadata/core-flow-acceptance-20260710.json` | `2026-07-10T03:53:00Z` | `BLOCKED` | blocked=2, environmentSmoke=9/9 PASS, fail=0, pass=11, platformSmoke=6/6 PASS, postgresMapperAudit=0 error / 0 warning, postgresRuntimeSmoke=8/8 PASS |
| `coreFlowRuntimeRollback` | `metadata/core-flow-runtime-rollback-rehearsal.json` | `2026-07-10T03:46:38.472Z` | `PASS` | None |
| `cutoverGate` | `metadata/production-cutover-gate.json` | `2026-07-10T04:01:20+00:00` | `NOT_READY_FOR_PRODUCTION_CUTOVER` | blocked=1, notStarted=0, planned=8, productionBacklogItems=9, productionBlockers=6, ready=0, totalGates=9 |
...
| `migrationReadiness` | `metadata/production-migration-readiness.json` | `2026-07-10T04:01:20+00:00` | `NOT_READY_FOR_PRODUCTION_MIGRATION` | blocked=1, notStarted=0, planned=8, ready=0, totalTracks=9 |
...
| `productionBacklog` | `metadata/production-module-backlog.json` | `2026-07-10T03:55:34Z` | `BLOCKED` | blocked=9, failBacklog=0, totalItems=9 |
| `productionBlockers` | `metadata/production-module-blockers.json` | `2026-07-10T03:55:34Z` | `BLOCKED` | blockedCases=6, blockers=6 |
