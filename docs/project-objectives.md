...
2. 保持已通过的目标环境 Flyway V9、真实 ADP 会话、页面拓扑创建/校验、独立发布、规则绑定、PostgreSQL marker 和重启读取作为发布回归；继续补版本比较、审批和产品级回退，日常配置不得回退到 SQL fixture。
