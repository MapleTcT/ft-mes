...
| documentation-or-workflow | 72 | Documentation/template reference; keep wording aligned with PostgreSQL-first policy. |
...
| docs/sustainable-development.md | 9 |
| Makefile | 8 |
