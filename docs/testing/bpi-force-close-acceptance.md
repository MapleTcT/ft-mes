...
本轮证明受控人工兜底的产品和持久化合同，不把它解释为自动批次边界已经现场投产。正式身份系统
第二管理员会话已由后续 marker `ADP_BPI_FORMAL_IDENTITY_20260721134944` 通过两套真实 ADP 浏览器
会话闭合，见 [BPI 正式身份双管理员强制结束验收](bpi-formal-identity-force-close-acceptance.md)。物理设备
END 证据、真实连续 7-14 天、外部 QCS 以及外部 ERP/WMS 仍按 G-021 的生产准入门禁推进。
