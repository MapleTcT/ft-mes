...
| G-018 | 业务模块完整测试用例 | PARTIAL | 53 个既有业务页面 smoke 已有证据；生产模块矩阵当前 `39 PASS / 4 BLOCKED / 0 NOT_RUN`；落库总账当前 `163 PASS / 0 FAIL / 3 BLOCKED / 2 NOT_APPLICABLE`。WOM 最新工具栏 marker 为 `ADP_E2E_20260622131959_WOMSTART_HOLD_RESTART`、taskId `9000006343993284`、generatedAt `2026-06-22T13:21:24.930Z`；PATROL 计划/取消 22/22，录入标准、路线、区域、巡检项分别 16/16、15/15、21/21、21/21，执行完成 32/32；异常隐患 marker `ADP_E2E_20260717003024_PATROL_HIDDEN_DANGER` 进一步通过异常结果、幂等生成待治理隐患、PostgreSQL 关联及 EAM 来源“巡检”复显 45/45，浏览器错误为 0；material/WMS 与 ProcessAnalysis 已闭合。 | PATROL 统计和完整 SESH 整改/复查/销项仍待处理；另有 4 条生产用例、二维码运行端点、生产导出其余目标和业务负责人签字未完成。 |
