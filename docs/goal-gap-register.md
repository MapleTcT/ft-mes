...
| Field | Value |
| --- | --- |
| Generated At | `2026-07-16T21:35:43+00:00` |
...
| `G-018` | `PARTIAL` | 业务模块完整测试用例 | 剩余 4 条生产用例、独立不良数量等产品范围项、二维码/导出和业务负责人签字未完成；ProcessAnalysis 已闭合。 | 保持 material/WMS、ProcessAnalysis、PATROL 配置 CRUD 和任务执行完成链回归，继续 PATROL 异常/隐患与统计，以及产品范围、二维码、外部客户端和导出验收，并补齐 before/after SQL、文件响应和业务签字。 |
