...
- Generated At：`2026-07-22T15:15:16+00:00`。
- Repo Commit：`ef8036b8b71718f3bb4f65ede3e9ba9cca093a82`。
- CI 阻断问题：`0`。
- 迁移缺口：`1`。
- 关注项：`2`。
- 计划项：`1`。
...
| oracle-audit-current-and-classified | pass | no | generatedAt=2026-07-22T15:14:40+00:00, repoCommit=ef8036b8b71718f3bb4f65ede3e9ba9cca093a82, unclassified=0, findingCount=1622, categoryTotal=1622 | 先运行 `make oracle-audit`；新增 Oracle 引用必须分类到 backlog、legacy、tooling 或文档路径。 |
...
| recovered-source-inventory | pass | no | 250 source jars, 991 frontend files, 76 compose services. | 新增包、服务或 source map 后运行 `make inventory`。 |
