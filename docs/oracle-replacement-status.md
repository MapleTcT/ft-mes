...
- Generated At：`2026-07-20T02:19:14+00:00`。
- Repo Commit：`6b53ecfcb499a2485e22b3aed782e20e0985518a`。
- CI 阻断问题：`0`。
- 迁移缺口：`1`。
- 关注项：`2`。
- 计划项：`1`。
...
| oracle-legacy-only | watch | no | Oracle migration backlog has 1598 tracked references. | 逐模块清理 backlog；删除引用前必须保留 PostgreSQL 替代证据。 |
| oracle-audit-current-and-classified | pass | no | generatedAt=2026-07-20T02:18:03+00:00, repoCommit=6b53ecfcb499a2485e22b3aed782e20e0985518a, unclassified=0, findingCount=1598, categoryTotal=1598 | 先运行 `make oracle-audit`；新增 Oracle 引用必须分类到 backlog、legacy、tooling 或文档路径。 |
