...
| Field | Value |
| --- | --- |
| Generated At | `2026-07-17T10:22:51+00:00` |
...
| `productionBlockers` | `metadata/production-module-blockers.json` | `BLOCKED` | blockedCases=3, blockers=3 |
| `productionBacklog` | `metadata/production-module-backlog.json` | `BLOCKED` | blocked=4, failBacklog=0, totalItems=4 |
