...
| `productionBlockers` | `metadata/production-module-blockers.json` | `BLOCKED` | blockedCases=4, blockers=4 |
| `productionBacklog` | `metadata/production-module-backlog.json` | `BLOCKED` | blocked=7, failBacklog=0, totalItems=7 |
