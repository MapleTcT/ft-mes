...
function openCompanyCertLevelRef() {
	...
	ReactAPI.createDialog("companyCertLevelDialog", {
		...
		url: "/msService/Qualify/certificate/certificateLevel/certLevelRef?refKey=certLvId.code&fromViewCode=Qualify_1.0.0_companyCertificate_companyCertEdit&type=company&customConditionKey=type",
		size: 5,
		isRef: true, // 是否开启参照
