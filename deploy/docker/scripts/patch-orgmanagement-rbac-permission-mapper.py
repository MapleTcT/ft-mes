...
""": """        FP.ID AS ID, MO.ID AS MENUOPERATE_ID,MO.CODE AS MENUOPERATE_CODE, FP.TYPE_ID AS USER_ID,
        CASE WHEN FP.GROUP_POWER_FLAG IS NULL THEN NULL WHEN FP.GROUP_POWER_FLAG THEN 1 ELSE 0 END AS GROUP_FLAG,
        CASE WHEN FP.POSITION_POWER_FLAG IS NULL THEN NULL WHEN FP.POSITION_POWER_FLAG THEN 1 ELSE 0 END AS POSITION_FLAG,
        CASE WHEN FP.ASSIGN_POS_FLAG IS NULL THEN NULL WHEN FP.ASSIGN_POS_FLAG THEN 1 ELSE 0 END AS ASSIGN_POS_FLAG,0 AS DEPARTMENT_FLAG, 0 AS ASSIGN_DEPT_FLAG,
        CASE WHEN FP.ASSIGN_STAFF_FLAG IS NULL THEN NULL WHEN FP.ASSIGN_STAFF_FLAG THEN 1 ELSE 0 END AS ASSIGN_STAFF_FLAG,
        CASE WHEN FP.UNLIMITED_POWER IS NULL THEN NULL WHEN FP.UNLIMITED_POWER THEN 1 ELSE 0 END AS NO_RESTRICT_FLAG,0 as DEALER_PERMISSION_FLAG,0 AS ASSIGN_CUSTOMPERMISSION_FLAG,0 AS ASSIGN_DATAPERMISSION_FLAG,0 as TYPEFLAG ,
""",
...
""": """        UP.ID, UP.MENUOPERATE_ID,UP.MENUOPERATE_CODE, UP.USER_ID, UP.GROUP_FLAG,
        CASE WHEN UP.POSITION_FLAG IS NULL THEN NULL WHEN UP.POSITION_FLAG THEN 1 ELSE 0 END AS POSITION_FLAG,
        CASE WHEN UP.ASSIGN_POS_FLAG IS NULL THEN NULL WHEN UP.ASSIGN_POS_FLAG THEN 1 ELSE 0 END AS ASSIGN_POS_FLAG,
        CASE WHEN UP.DEPARTMENT_FLAG IS NULL THEN NULL WHEN UP.DEPARTMENT_FLAG THEN 1 ELSE 0 END AS DEPARTMENT_FLAG,
        CASE WHEN UP.ASSIGN_DEPT_FLAG IS NULL THEN NULL WHEN UP.ASSIGN_DEPT_FLAG THEN 1 ELSE 0 END AS ASSIGN_DEPT_FLAG,
        CASE WHEN UP.ASSIGN_STAFF_FLAG IS NULL THEN NULL WHEN UP.ASSIGN_STAFF_FLAG THEN 1 ELSE 0 END AS ASSIGN_STAFF_FLAG,
        CASE WHEN UP.NO_RESTRICT_FLAG IS NULL THEN NULL WHEN UP.NO_RESTRICT_FLAG THEN 1 ELSE 0 END AS NO_RESTRICT_FLAG,
        CASE WHEN UP.DEALER_PERMISSION_FLAG IS NULL THEN NULL WHEN UP.DEALER_PERMISSION_FLAG THEN 1 ELSE 0 END AS DEALER_PERMISSION_FLAG,
        CASE WHEN UP.ASSIGN_CUSTOMPERMISSION_FLAG IS NULL THEN NULL WHEN UP.ASSIGN_CUSTOMPERMISSION_FLAG THEN 1 ELSE 0 END AS ASSIGN_CUSTOMPERMISSION_FLAG,
        CASE WHEN UP.ASSIGN_DATAPERMISSION_FLAG IS NULL THEN NULL WHEN UP.ASSIGN_DATAPERMISSION_FLAG THEN 1 ELSE 0 END AS ASSIGN_DATAPERMISSION_FLAG,
...
""": """        UP.ID, UP.USER_ID USER_ID, MI.NAME MENU_NAME, MO.NAME OPERATE_NAME, MO.FLOW_KEY FLOW_KEY, UP.GROUP_FLAG GROUP_FLAG,
        CASE WHEN UP.POSITION_FLAG IS NULL THEN NULL WHEN UP.POSITION_FLAG THEN 1 ELSE 0 END POSITION_FLAG,
        CASE WHEN UP.ASSIGN_POS_FLAG IS NULL THEN NULL WHEN UP.ASSIGN_POS_FLAG THEN 1 ELSE 0 END ASSIGN_POS_FLAG,
        CASE WHEN UP.ASSIGN_STAFF_FLAG IS NULL THEN NULL WHEN UP.ASSIGN_STAFF_FLAG THEN 1 ELSE 0 END ASSIGN_STAFF_FLAG,
        CASE WHEN UP.DEALER_PERMISSION_FLAG IS NULL THEN NULL WHEN UP.DEALER_PERMISSION_FLAG THEN 1 ELSE 0 END DEALER_PERMISSION_FLAG,
        CASE WHEN UP.NO_RESTRICT_FLAG IS NULL THEN NULL WHEN UP.NO_RESTRICT_FLAG THEN 1 ELSE 0 END NO_RESTRICT_FLAG, 1 as TYPEFLAG,
""",
...
""": """        FP.ID, FP.TYPE_ID USER_ID, MI.NAME MENU_NAME, MO.NAME OPERATE_NAME, MO.FLOW_KEY FLOW_KEY,
        CASE WHEN FP.GROUP_POWER_FLAG IS NULL THEN NULL WHEN FP.GROUP_POWER_FLAG THEN 1 ELSE 0 END GROUP_FLAG,
        CASE WHEN FP.POSITION_POWER_FLAG IS NULL THEN NULL WHEN FP.POSITION_POWER_FLAG THEN 1 ELSE 0 END POSITION_FLAG,
        CASE WHEN FP.ASSIGN_POS_FLAG IS NULL THEN NULL WHEN FP.ASSIGN_POS_FLAG THEN 1 ELSE 0 END ASSIGN_POS_FLAG,
        CASE WHEN FP.ASSIGN_STAFF_FLAG IS NULL THEN NULL WHEN FP.ASSIGN_STAFF_FLAG THEN 1 ELSE 0 END ASSIGN_STAFF_FLAG,
        0 as DEALER_PERMISSION_FLAG,
        CASE WHEN FP.UNLIMITED_POWER IS NULL THEN NULL WHEN FP.UNLIMITED_POWER THEN 1 ELSE 0 END NO_RESTRICT_FLAG, 0 as TYPEFLAG,
""",
...
""": """        RP.ID, RU.USER_ID USER_ID, MI.NAME MENU_NAME, MO.NAME OPERATE_NAME, MO.FLOW_KEY FLOW_KEY, RP.GROUP_FLAG GROUP_FLAG,
        CASE WHEN RP.POSITION_FLAG IS NULL THEN NULL WHEN RP.POSITION_FLAG THEN 1 ELSE 0 END POSITION_FLAG,
        CASE WHEN RP.ASSIGN_POS_FLAG IS NULL THEN NULL WHEN RP.ASSIGN_POS_FLAG THEN 1 ELSE 0 END ASSIGN_POS_FLAG,
        CASE WHEN RP.ASSIGN_STAFF_FLAG IS NULL THEN NULL WHEN RP.ASSIGN_STAFF_FLAG THEN 1 ELSE 0 END ASSIGN_STAFF_FLAG,
        CASE WHEN RP.DEALER_PERMISSION_FLAG IS NULL THEN NULL WHEN RP.DEALER_PERMISSION_FLAG THEN 1 ELSE 0 END DEALER_PERMISSION_FLAG,
        CASE WHEN RP.NO_RESTRICT_FLAG IS NULL THEN NULL WHEN RP.NO_RESTRICT_FLAG THEN 1 ELSE 0 END NO_RESTRICT_FLAG, 2 as TYPEFLAG,
""",
}
...
def patch_mapper(xml_bytes: bytes) -> tuple[bytes, int]:
    ...
    for old, new in REPLACEMENTS.items():
        if old in xml:
            ...
            raise ValueError(f"expected mapper fragment not found:\n{old}")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Patch orgmanagement RBAC permission mapper for PostgreSQL boolean UNION compatibility."
    )
