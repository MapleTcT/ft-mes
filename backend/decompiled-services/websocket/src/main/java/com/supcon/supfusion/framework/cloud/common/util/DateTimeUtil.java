...
public class DateTimeUtil {
    ...
    public static final DateTimeFormatter UTC0_FORMAT = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss.SSSZ");

    public static LocalDateTime getUTC0DateTime() {
        return LocalDateTime.ofInstant(new Date().toInstant(), ZoneId.of("UTC"));
    }

    public static ZonedDateTime getZonedUTC0DateTime() {
        return ZonedDateTime.of(DateTimeUtil.getUTC0DateTime(), ZoneId.of("UTC"));
    }

    public static String getUTC0() {
        return DateTimeUtil.getZonedUTC0DateTime().format(UTC0_FORMAT);
    }
