package com.supcon.supfusion.organization.openapi.vo.compatible.department;
...
public class DepartmentAddVO extends VO {
    ...
    @Size(min = 1, max = 50, message = Constants.DEPARTMENT_PARAM_NAME_LENGTH_ERROR)
     ...
     * 描述
     */
    @Size(max = 255, message = Constants.DEPARTMENT_PARAM_DESC_LENGTH_ERROR)
