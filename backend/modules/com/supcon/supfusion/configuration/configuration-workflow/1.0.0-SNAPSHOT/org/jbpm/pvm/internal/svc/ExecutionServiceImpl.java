...
///////////////////////////////////////////自定义/////////////////////////////////////////
	...
	@Override
	public ProcessInstance startProcessInstanceById(String processDefinitionId, Map<String, ?> variables, WorkFlowVar workFlowVar) {
		return commandService.execute(new StartProcessInstanceCmd(processDefinitionId, variables, null, workFlowVar));
	}
