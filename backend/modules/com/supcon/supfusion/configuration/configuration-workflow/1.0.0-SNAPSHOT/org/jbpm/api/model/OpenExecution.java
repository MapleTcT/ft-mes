...
public interface OpenExecution extends Execution {
	///////////////////////////////////////自定义////////////////////////////////////////
	Long getProcessInitiator();
	Long getTableInfoId();
	Long getDeploymentId();
	String getEntityCode();
	void setWorkFlowVar(WorkFlowVar workFlowVar);
	void setProcessInitiator(Long processInitiator);
	void setTableInfoId(Long tableInfoId);
	void setDeploymentId(Long deploymentId);
	void setEntityCode(String entityCode);
	void setScriptExcuteBeanName(String beanName);
	String getScriptExcuteBeanName();
	Long getOwnerId() ;
	void setOwnerId(Long ownerId);
	Long getOwnerPositionId();
	void setOwnerPositionId(Long ownerPositionId);
	Long getInitiatorPositionId();
	void setInitiatorPositionId(Long initiatorPositionId);
//	String getInitiatorGroupIds();
//	void setInitiatorGroupIds(String initiatorGroupIds);
	Long getModelId();
	...
	Boolean getGroupEnabled() ;
	void setGroupEnabled(Boolean groupEnabled);
	Boolean getCrossCompanyFlag() ;
	void setCrossCompanyFlag(Boolean crossCompanyFlag);
	VariablesProvider getVariablesProvider();
	Set<Long> getAssignUsers();
	void setAssignUsers(Set<Long> assignUsers);
	void setOperateType(String operateType);
