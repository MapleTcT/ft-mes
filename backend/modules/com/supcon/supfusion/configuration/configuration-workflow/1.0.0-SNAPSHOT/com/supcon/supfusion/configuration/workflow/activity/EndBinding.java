 ...
 * @author Tom Baeyens
 */
public class EndBinding extends AbstractNoticeBinding {
	...
	public Object parseJpdl(Element element, Parse parse, JpdlParser parser) {
		...
		String effect = XmlUtil.attribute(element, "effectFlag");
		if (effect != null && effect.equals("false")) {
			endActivity.setEffect(false);
		} else {
			endActivity.setEffect(true);// 默认结束即生效
		}
		
		endActivity.setNoticeTransit(parseNotice(element, parse, parser));// 解析消息提醒
