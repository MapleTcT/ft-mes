...
public class StartHsqldbServerTask extends Task {
	private static final Log log = LogFactory.getLog(StartHsqldbServerTask.class);
	...
	public void execute() throws BuildException {
		try {
			...
			if (os.indexOf("windows") != -1) {
				command = new String[] { getHsqldbServerHome() + fileSeparator
				...
				throw new BuildException("os '" + os
						+ "' not supported in the start-hsqldb-server task.");
			}
