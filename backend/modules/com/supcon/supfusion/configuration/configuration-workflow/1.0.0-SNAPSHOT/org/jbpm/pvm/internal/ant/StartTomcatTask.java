...
public class StartTomcatTask extends Task {
	private static final Logger logger = LoggerFactory.getLogger(StartTomcatTask.class);
	...
	public void execute() throws BuildException {
		try {
			...
			if (os.indexOf("windows") != -1) {
				command = new String[] {
						getTomcatHome() + fileSeparator + "bin" + fileSeparator
								+ "catalina.bat", "run" };
				...
				throw new BuildException("os '" + os
						+ "' not supported in the start-tomcat task.");
			}
	...
	String getTomcatHome() {
		...
		throw new BuildException(
				"start-tomcat couldn't figure out which tomcat to start: attribute tomcathome not specified and property tomcat.home was not set");
	}
