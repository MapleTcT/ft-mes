...
import org.jbpm.pvm.internal.stream.*;
...
public class DeploymentImpl extends ProblemList implements NewDeployment {
  ...
  protected final Map<String, Lob> resources = new HashMap<String, Lob>();
...
//    }
    ...
    try {
      ...
      lob.setDbid(DbidGenerator.getNextId("JBPM4_LOB",1, null));
  ...
  public void initResourceLobDbids() {
    if (resources != null) {
      for (Lob resource : resources.values()) {
        long resourceDbid = DbidGenerator.getNextId("JBPM4_LOB",1, null);
