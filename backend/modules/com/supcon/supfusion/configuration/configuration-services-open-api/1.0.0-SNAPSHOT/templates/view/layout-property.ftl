...
<form>
	<table class="infoTable" cellpadding="0" cellspacing="0" border="0" width="95%" align="left" style="margin-top: 10px">
		<tr>
			...
			<td class="la block_view" align="right" style="padding-right:5px">${getHtmlText('ec.MenuInfo.ChoiceViews')} </td>
			<td class="co block_view" colspan="3"><select id="lp_vcode" name="lp_vcode">
				<option value=""></option>
				<#list viewList as v>
				<#if v.showType != 'LAYOUT' && v.showType == 'PART' && v.type == view.type>
		...
		<tr>
			<td class="la" width="20%" align="right" style="padding-right:5px">${getHtmlText('ec.view.width')} </td>
			<td class="co" width="30%"> <input type="text" class="cui-edit-field" id="lp_width" name="lp_width" /></td>
			<td class="la" width="20%" align="right" style="padding-right:5px">${getHtmlText('ec.view.high')} </td>
			<td class="co" width="30%"> <input type="text" class="cui-edit-field" id="lp_height" name="lp_height" /></td>
		</tr>
		<tr>
			<td class="la" align="right" style="padding-right:5px">${getHtmlText('ec.view.showtype')}</td>
			<td class="co">
			...
			<td class="la permissionTd block_tree" align="right" style="padding-right:5px;display:none;">${getHtmlText('ec.view.isPermission')}</td>
		...
		<tr style="display:none;" class="block block_tree">
			<td class="la crossCompanyFlagTd block_tree" align="right" style="padding-right:5px;display:none;">${getHtmlText('ec.entity.crossCompanyFlag')}</td>
		...
		<tr style="display:none;" class="block block_tree">
			<td class="la" align="right" style="padding-right:5px">${getHtmlText('ec.view.treemodel')} </td>
			<td class="co">
			...
			<td class="la" align="right" style="padding-right:5px">${getHtmlText('ec.view.showfield')}</td>
			<td class="co">
		...
		<tr style="display:none;" class="block block_tree">
			<td class="la" align="right" style="padding-right:5px">${getHtmlText('ec.view.querycondition')} </td>
			<td class="co" colspan="3">
				<input type="text" class="cui-edit-field" id="lp_tree_cond" name="lp_tree_cond" />
			</td>
		</tr>
		<tr style="display:none;" class="block block_tree">
			<td class="la" align="right" style="padding-right:5px">${getHtmlText('ec.view.rootname')}</td>
			<td class="co" colspan="3">
				<input type="text" class="cui-edit-field" id="lp_tree_root" name="lp_tree_root" />
			</td>
		</tr>
		<tr style="display:none;" class="block block_tree">
			<td class="la" align="right" style="padding-right:5px">JSON${getHtmlText('ec.view.datasource')} </td>
			<td class="co" colspan="3">
		...
		<tr style="display:none;" class="block block_tree">
			<td class="la" align="right" style="padding-right:5px">ONDBLCLICK </td>
			<td class="co" colspan="3">
