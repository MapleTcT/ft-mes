	...
	<style type="text/css">
	#select-property-wrap .col-sub { margin-left:5px;margin-top:5px;width: 140px; float:left;background-color:white;border: none;cursor: pointer;}
	</style>
	...
	<div class="layout grid-s4m0" id="select-property-wrap"> 	
		<div class="col-sub">
			<#-- 左侧 -->
