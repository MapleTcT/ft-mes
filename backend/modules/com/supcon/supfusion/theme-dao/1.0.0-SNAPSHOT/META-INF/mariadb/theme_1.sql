...
insert into system_theme(id,theme,logo,font,status) select 1000,'default','/theme/logo/logo.png',12,1 from DUAL where not exists(select theme from system_theme where theme='default');
insert into system_theme(id,theme,logo,font,status) select 1001,'dark','/theme/logo/logo.png',12,0 from DUAL where not exists(select theme from system_theme where theme='dark');