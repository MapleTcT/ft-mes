package com.supcon.supfusion.organization.common.swagger;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.supcon.supfusion.organization"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("组织架构2.0界面操作接口")
                .description("API描述信息")
                .contact(new Contact("联系开发人员", "http://{domain}:{port}/{basePath}", "shidongsheng@supcon.com"))
                .version("1.0.0")
                .build();
    }
