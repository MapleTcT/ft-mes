...
public interface ModuleRegistryApi {
     ...
     * @param appId
     */
    @PostMapping(HttpConstants.URL_SERVICEAPI + HttpConstants.URL_SPLITER + "module-registry/modules")
    void addModuleApp(@RequestBody AddModuleAppDTO addModuleRequest);
     ...
     * @return
     */
    @DeleteMapping(HttpConstants.URL_SERVICEAPI + HttpConstants.URL_SPLITER + "module-registry/modules/{appId}")
    void deleteModuleApp(@PathVariable("appId") String appId);
     ...
     * @return
     */
    @PutMapping(HttpConstants.URL_SERVICEAPI + HttpConstants.URL_SPLITER + "module-registry/modules")
    void upgradeModuleApp(@RequestBody UpgradeModuleAppDTO upgradeModuleAppDTO);
     ...
     * @return
     */
    @GetMapping(HttpConstants.URL_SERVICEAPI + HttpConstants.URL_SPLITER + "module-registry/modules/single/{appId}")
    List<String> singleApp(@PathVariable("appId") String appId);
}
