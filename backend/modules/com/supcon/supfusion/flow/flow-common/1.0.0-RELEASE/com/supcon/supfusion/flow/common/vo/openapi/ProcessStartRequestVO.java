 ...
 */
@Data
@ApiModel(value = "ProcessStartRequestVO", description = "启动流程参数模型")
public class ProcessStartRequestVO extends BaseRequestVO {
     ...
     * 指派者列表
     */
    @ApiModelProperty(value = "指派者列表", name = "assigns", example = "[{\"id\": \"111223\", \"users\": [\"999\",\"101\"]}]")
