...
@Configuration
@EnableSwagger2
@ConditionalOnProperty(name = "supfusion.swagger.enable", matchIfMissing = false)
public class PortalSwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
				.apis(basePackage("com.supcon.supfusion.portal.webapi.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("portal Api Document").version("1.0.0")
				.description("门户管理").build();
	}
}
