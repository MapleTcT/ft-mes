package com.supcon.supfusion.rbac.webapi.swagger;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
				.apis(basePackage("com.supcon.supfusion.rbac.openapi"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("rbac Api Document").version("1.0.0")
				.description("用户角色权限").build();
	}
}
