...
public class ControllerAspect {
    ...
    @Pointcut("execution(public * com.supcon.supfusion.auth.openapi.controller..*.*(..)) ||" +
            "execution(public * com.supcon.supfusion.auth.webapi.controller..*.*(..)) ||" +
            "execution(public * com.supcon.supfusion.auth.service.rpc..*.*(..))"
    )
    ...
    public Object intoControllerLog(ProceedingJoinPoint point) throws Throwable {
        ...
        RpcContext.getContext().setTraceId(Long.valueOf(uid));
        ...
        try {
         ...
         //
        // 类名+方法名
        sb.append("class: " + clazz + "." + method.getName())
                .append("(")
