...
public interface SystemCodeApiService {
    ...
    @ResponseBody
    ListResult<SystemCodeResultDTO> queryValueListNoPage(@NotBlank(message = "systemCode.CODE_PARAM_NECESSARY") @RequestParam("entityCode") String entityCode, String keyword, String displayName);
     ...
     * @param codes
     */
    @PostMapping(value = "/{entityCode}/values/{codes}")
...
//                                                 @Min(value = 1, message = "systemCode.CURRENT_PAGE_MIN_1") @RequestParam("current") Integer current, @Min(value = 1, message = "systemCode.CURRENT_PAGE_MIN_1") @RequestParam("pageSize") Integer pageSize);
     ...
     * @return
     */
    @GetMapping(value = "/entity/value/code")
    @ResponseBody
