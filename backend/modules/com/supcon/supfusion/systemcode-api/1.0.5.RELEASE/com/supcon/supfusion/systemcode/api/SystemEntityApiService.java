...
public interface SystemEntityApiService {
     ...
     * @return
     */
    @GetMapping(value = API_PREFIX + "/entities")
    @ResponseBody
    PageResult<SystemEntityResultDTO> queryEntities(@RequestParam(value = "keyword", required = false) String keyword,
     ...
     * @return
     */
    @GetMapping(value = API_PREFIX + "/entity")
    @ResponseBody
     ...
     */
    @PostMapping(value = API_PREFIX + "/entity")
     ...
     */
    @PutMapping(value = API_PREFIX + "/entity")
     ...
     * @param code
     */
    @DeleteMapping(value = API_PREFIX + "/entity/{code}")
     ...
     * @param codes
     */
    @PostMapping(value = API_PREFIX + "/entities/{codes}")
     ...
     *
     */
    @GetMapping(value = API_PREFIX + "/entitys/systemBase")
    @ResponseBody
     ...
     * @return
     */
    @GetMapping(value = API_PREFIX + "/entities/moduleIds/simple")
    @ResponseBody
    PageResult<SystemEntityResultDTO> queryEntitiesByModuleIds(@RequestParam(value = "moduleIds", required = false) String moduleIds,
                                                    @Min(value = 1, message = "systemCode.CURRENT_PAGE_MIN_1") @RequestParam("current") Integer current,
                                                    @Min(value = 1, message = "systemCode.CURRENT_PAGE_MIN_1") @RequestParam("pageSize") Integer pageSize);
