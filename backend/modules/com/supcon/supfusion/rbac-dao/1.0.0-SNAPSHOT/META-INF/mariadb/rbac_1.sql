...
create or replace
algorithm = UNDEFINED view base_datapermission as (
select
    rbac_flow_permission.ID as id,
    rbac_flow_permission.VERSION as version,
    rbac_flow_permission.CREATE_STAFF_ID as create_staff_id,
    rbac_flow_permission.MODIFY_STAFF_ID as modify_staff_id,
    null as delete_staff_id,
    rbac_flow_permission.CREATE_TIME as create_time,
    rbac_flow_permission.MODIFY_TIME as modify_time,
    rbac_flow_permission.DELETE_TIME as delete_time,
    1 as valid,
    rbac_flow_permission.ENTITY_CODE as entity_code,
    rbac_flow_permission.PURVIEW_DISTRIBUTION as purview_distribution,
    rbac_flow_permission.PURVIEW_STATE as purview_state,
    rbac_flow_permission.MEMO as memo,
    rbac_flow_permission.UNLIMITED_POWER as unlimited_power,
    rbac_flow_permission.GROUP_POWER_FLAG as group_power_flag,
    rbac_flow_permission.ASSIGN_STAFF_FLAG as assign_staff_flag,
    rbac_flow_permission.ASSIGN_POS_FLAG as assign_pos_flag,
    rbac_flow_permission.POSITION_POWER_FLAG as position_power_flag,
    rbac_flow_permission.FLOW_PERMISSION_TYPE as data_permission_type,
    rbac_flow_permission.TYPE_ID as type_id,
    rbac_flow_permission.ACTIVITY_CODE as activity_code,
    rbac_flow_permission.FLOW_VERSION as flow_version,
    rbac_flow_permission.FLOW_KEY as flow_key
from
    rbac_flow_permission);

create or replace
algorithm = UNDEFINED view base_datapermissionstaff as (
select
    rbac_flow_permission_staff.ID as id,
    rbac_flow_permission_staff.VERSION as version,
    rbac_flow_permission_staff.staff_id as staff_id,
    rbac_flow_permission_staff.flowpermission_id as DATAPERMISSION_ID
from
    rbac_flow_permission_staff);

create or replace
algorithm = UNDEFINED view base_datapmsposition as (
select
    rbac_flow_permission_position.ID as id,
    rbac_flow_permission_position.VERSION as version,
    rbac_flow_permission_position.position_id as position_id,
    rbac_flow_permission_position.include_lower as include_lower,
    rbac_flow_permission_position.flowpermission_id as DATAPERMISSION_ID
from
    rbac_flow_permission_position);

create or replace
algorithm = UNDEFINED view base_menuinfo as (
select
    rbac_menuinfo.ID as id,
    rbac_menuinfo.VERSION as version,
    rbac_menuinfo.CREATE_STAFF_ID as create_staff_id,
    rbac_menuinfo.MODIFY_STAFF_ID as modify_staff_id,
    null as delete_staff_id,
    rbac_menuinfo.CREATE_TIME as create_time,
    rbac_menuinfo.MODIFY_TIME as modify_time,
    rbac_menuinfo.DELETE_TIME as delete_time,
    rbac_menuinfo.VALID as valid,
    rbac_menuinfo.CID as cid,
    rbac_menuinfo.SECURITY_CLASS as security_class,
    rbac_menuinfo.ABSOLUTE_HIDDEN as absolute_hidden,
    rbac_menuinfo.THREE_ROLE as three_role,
    rbac_menuinfo.SHOW_TYPE as show_type,
    rbac_menuinfo.REQUEST_TYPE as request_type,
    rbac_menuinfo.HIDDEN_TYPE as hidden_type,
    rbac_menuinfo.MENU_TYPE as menu_type,
    rbac_menuinfo.IS_HIDE as is_hide,
    rbac_menuinfo.GROUP_ONLY as group_only,
    rbac_menuinfo.ENTITY_CODE as entity_code,
    rbac_menuinfo.ENTITY_CODE as ec_entity_code,
    rbac_menuinfo.MODULE_CODE as module_code,
    rbac_menuinfo.SYSTEM_DEFAULT as system_default,
    rbac_menuinfo.CSS_CLASS as css_class,
    rbac_menuinfo.SORT as sort,
    rbac_menuinfo.NAMESPACE as namespace,
    rbac_menuinfo.URL as url,
    rbac_menuinfo.TARGET as target,
    rbac_menuinfo.MEMO as memo,
    rbac_menuinfo.NAME as name,
    rbac_menuinfo.NAME_DISPLAY as name_zh_cn,
    rbac_menuinfo.CODE as code,
    rbac_menuinfo.LAY_NO as lay_no,
    rbac_menuinfo.LAY_REC as lay_rec,
    rbac_menuinfo.PARENT_ID as parent_id,
    rbac_menuinfo.FULL_PATH_NAME as full_path_name,
    rbac_menuinfo.ACTION_URL as ACTION,
    rbac_menuinfo.LEAF as leaf,
    null as ST_FLAG,
    null as ST_DIGITALSIGNATURE,
    null as ST_INTRO,
    null as ST_TABTYPEID,
    ...
    null as MODULE,
    null as ICON_URL,
    rbac_menuinfo.STATUS as status
from
    rbac_menuinfo);

create or replace
algorithm = UNDEFINED view base_menuoperate as (
select
    rbac_menuoperate.ID as id,
    rbac_menuoperate.ROW_VERSION as version,
    rbac_menuoperate.CREATE_STAFF_ID as create_staff_id,
    rbac_menuoperate.MODIFY_STAFF_ID as modify_staff_id,
    null as delete_staff_id,
    rbac_menuoperate.CREATE_TIME as create_time,
    rbac_menuoperate.MODIFY_TIME as modify_time,
    rbac_menuoperate.DELETE_TIME as delete_time,
    rbac_menuoperate.VALID as valid,
    rbac_menuoperate.CID as cid,
    rbac_menuoperate.IS_ALLOW_PROXY as is_allow_proxy,
    rbac_menuoperate.IS_HIDDEN as is_hidden,
    rbac_menuoperate.THREE_ROLE as three_role,
    rbac_menuoperate.VIEW_CODE as view_code,
    rbac_menuoperate.IS_QUERY as is_query,
    rbac_menuoperate.IS_ORRELATION as is_orrelation,
    rbac_menuoperate.FOR_FLOW_PERMISSION as for_data_permission,
    rbac_menuoperate.ENABLE_NORESTRICT as enable_norestrict,
    ...
    rbac_menuoperate.ENABLE_DEALERPERMISSION as enable_dealerpermission,
    rbac_menuoperate.ENABLE_ASSIGNSTAFF as enable_assignstaff,
    rbac_menuoperate.ENABLE_ASSIGNPOS as enable_assignpos,
    rbac_menuoperate.ENABLE_POSRESTRICT as enable_posrestrict,
    rbac_menuoperate.ENABLE_GROUPRESTRICT as enable_grouprestrict,
    rbac_menuoperate.ENTITY_CODE as entity_code,
    rbac_menuoperate.IGNORE_PERMISSION as ignore_permission,
    rbac_menuoperate.POWER_FLAG as power_flag,
    rbac_menuoperate.FLOW_VERSION as flow_version,
    rbac_menuoperate.FLOW_KEY as flow_key,
    rbac_menuoperate.MSG_ASSEMBLED as msg_assembled,
    rbac_menuoperate.DEPLOYMENT_ID as deployment_id,
    rbac_menuoperate.MENUOPERATETYPE as type,
    rbac_menuoperate.MENUINFO_ID as menuinfo_id,
    rbac_menuoperate.ICON_CLS as icon_cls,
    rbac_menuoperate.MODULE_CODE as module,
    rbac_menuoperate.SORT as sort,
    rbac_menuoperate.MEMO as memo,
    rbac_menuoperate.TARGET as target,
    rbac_menuoperate.NAMESPACE as namespace,
    rbac_menuoperate.URL as url,
    rbac_menuoperate.NAME_ZH_CN as name_zh_cn,
    rbac_menuoperate.NAME as name,
    rbac_menuoperate.CODE as code,
    ...
    null as MENUOPERATE_ISCONTAINER,
    null as MENUOPERATE_ENTRYOPERATECODE,
    rbac_menuoperate.MENUOPERATETYPE as MENUOPERATETYPE
from
    rbac_menuoperate);

create or replace
algorithm = UNDEFINED view base_role as (
select
    rbac_role.ID as id,
    rbac_role.VALID as valid,
    rbac_role.VERSION as version,
    rbac_role.CID as cid,
    rbac_role.LEAF as leaf,
    rbac_role.FULL_PATH_NAME as full_path_name,
    rbac_role.PARENT_ID as parent_id,
    rbac_role.LAY_NO as lay_no,
    rbac_role.LAY_REC as lay_rec,
    rbac_role.UUID as uuid,
    rbac_role.THREE_ROLE_TYPE as three_role_type,
    rbac_role.ROLE_TYPE as role_type,
    rbac_role.SORT as sort,
    rbac_role.DESCRIPTION as description,
    rbac_role.NAME as name,
    rbac_role.CODE as code,
    rbac_role.CREATE_STAFF_ID as create_staff_id,
    rbac_role.MODIFY_STAFF_ID as modify_staff_id,
    null as delete_staff_id,
    rbac_role.CREATE_TIME as create_time,
    rbac_role.MODIFY_TIME as modify_time,
    rbac_role.DELETE_TIME as delete_time
from
    rbac_role);
...
create or replace
algorithm = UNDEFINED view base_role_otherrestrict_ref as (
select
    rbac_role_custompermission_ref.ID as id,
    rbac_role_custompermission_ref.VERSION as version,
    rbac_role_custompermission_ref.CUSTOM_PERMISSION_CODE as other_restrict_code,
    rbac_role_custompermission_ref.ROLEPERMISSION_ID as rolepermission_id
from
    rbac_role_custompermission_ref);

create or replace
algorithm = UNDEFINED view base_role_specialpermission as (
select
    rbac_role_datapermission.ID as id,
    rbac_role_datapermission.VERSION as version,
    rbac_role_datapermission.CONFIG_STRING as config_string,
    rbac_role_datapermission.CONTENT as content,
    rbac_role_datapermission.DATA_PERMISSION_CODE as special_permission_code,
    rbac_role_datapermission.ROLEPERMISSION_ID as rolepermission_id
from
    rbac_role_datapermission);

create or replace
algorithm = UNDEFINED view base_rolepermission as (
select
    rbac_rolepermission.ID as id,
    rbac_rolepermission.VERSION as version,
    rbac_rolepermission.ROLE_ID as role_id,
    rbac_rolepermission.MENUOPERATE_ID as menuoperate_id,
    rbac_rolepermission.POSITION_FLAG as position_flag,
    rbac_rolepermission.GROUP_FLAG as group_flag,
    rbac_rolepermission.ASSIGN_STAFF_FLAG as assign_staff_flag,
    rbac_rolepermission.ASSIGN_POS_FLAG as assign_pos_flag,
    rbac_rolepermission.DEALER_PERMISSION_FLAG as dealer_permission_flag,
    rbac_rolepermission.NO_RESTRICT_FLAG as no_restrict_flag,
    rbac_rolepermission.ASSIGN_DATAPERMISSION_FLAG as assign_specialpermission_flag,
    rbac_rolepermission.ASSIGN_CUSTOMPERMISSION_FLAG as assign_otherrestrict_flag,
    rbac_rolepermission.URL_PATTERN as URL_PATTERN,
    rbac_rolepermission.CREATE_STAFF_ID as create_staff_id,
    rbac_rolepermission.MODIFY_STAFF_ID as modify_staff_id,
    null as delete_staff_id,
    rbac_rolepermission.CREATE_TIME as create_time,
    rbac_rolepermission.MODIFY_TIME as modify_time,
    rbac_rolepermission.DELETE_TIME as delete_time
from
    rbac_rolepermission);

create or replace
algorithm = UNDEFINED view base_rolepposition as (
select
    rbac_rolepposition.ID as id,
    rbac_rolepposition.VERSION as version,
    rbac_rolepposition.INCLUDE_LOWER as include_lower,
    rbac_rolepposition.POSITION_ID as position_id,
    rbac_rolepposition.ROLEPERMISSION_ID as rolepermission_id
from
    rbac_rolepposition);

create or replace
algorithm = UNDEFINED view base_rolepstaff as (
select
    rbac_rolepstaff.ID as id,
    rbac_rolepstaff.VERSION as version,
    rbac_rolepstaff.STAFF_ID as staff_id,
    rbac_rolepstaff.ROLEPERMISSION_ID as rolepermission_id
from
    rbac_rolepstaff);

create or replace
algorithm = UNDEFINED view base_roleuser as (
select
    rbac_roleuser.ID as id,
    rbac_roleuser.VERSION as version,
    rbac_roleuser.POSITION_FLAG as position_flag,
    rbac_roleuser.ROLE_ID as role_id,
    rbac_roleuser.USER_ID as user_id,
    rbac_roleuser.VALID as valid,
    rbac_roleuser.END_TIME as end_time,
    rbac_roleuser.START_TIME as start_time
from
    rbac_roleuser);

create or replace
algorithm = UNDEFINED view base_user_otherrestrict_ref as (
select
    rbac_user_custompermission_ref.ID as id,
    rbac_user_custompermission_ref.VERSION as version,
    rbac_user_custompermission_ref.CUSTOM_PERMISSION_CODE as other_restrict_code,
    rbac_user_custompermission_ref.USERPERMISSION_ID as userpermission_id
from
    rbac_user_custompermission_ref);

create or replace
algorithm = UNDEFINED view base_user_specialpermission as (
select
    rbac_user_datapermission.ID as id,
    rbac_user_datapermission.VERSION as version,
    rbac_user_datapermission.CONFIG_STRING as config_string,
    rbac_user_datapermission.CONTENT as content,
    rbac_user_datapermission.DATA_PERMISSION_CODE as special_permission_code,
    rbac_user_datapermission.USERPERMISSION_ID as userpermission_id
from
    rbac_user_datapermission);
