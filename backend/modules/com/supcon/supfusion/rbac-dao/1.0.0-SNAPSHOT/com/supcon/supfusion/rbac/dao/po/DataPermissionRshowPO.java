 ...
 */
@Data
@TableName(value = "rbac_data_permission_rshow", autoResultMap=true)
public class DataPermissionRshowPO extends BaseEntity implements Serializable {


    private static final long serialVersionUID = -2241642654171543364L;
    /**
     * 主键ID
     */
    @TableId("ID")
