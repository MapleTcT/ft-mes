 ...
 */
@Data
@TableName(value = "rbac_userpermission", autoResultMap=true)
public class UserPermissionPO extends BaseEntity implements Serializable {


    private static final long serialVersionUID = 4071181936975697119L;
    /**
     * 主键ID
     */
    @TableId("ID")
