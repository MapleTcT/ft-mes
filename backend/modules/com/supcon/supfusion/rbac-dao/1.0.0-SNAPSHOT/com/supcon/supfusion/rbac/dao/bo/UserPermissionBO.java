...
public class UserPermissionBO {
     ...
     * 指定的员工
     */
    private List<UserPStaffPO> staffs = new ArrayList<>();
    /**
     * 指定的岗位
     */
    private List<UserPPositionPO> positions = new ArrayList<>();
    /**
     * 指定部门
     */
    private List<UserPDepartmentPO> departments = new ArrayList<>();
    /**
     * 自定义条件
     */
