...
public interface IMenuOperateApiService {
     ...
     * 根据userId 菜单code查询操作
     */
    @GetMapping(API_PREFIX + Constants.MENUOOPERATE + "/getOperateListByUserIdMenuId")
    @ResponseBody
    List<MenuOperateSimpleDTO> getOperateListByUserIdMenuId(@RequestParam(value = "userId", required = true) Long userId, @RequestParam(value = "menuCode", required = true) String menuCode);
