 ...
 *
 * @author liyiming
 * @date 2020/12/1 1:07 下午
 */
@Component
public class InternationalResource implements Serializable, InitializingBean, ApplicationContextAware {
    /*
     * 设置默认国际化语言
     */
     ...
     * 清空缓存
     */
    public static void initiativeRefreshCache() {
    ...
    private static Locale getLocale(String language) {
        ...
        String[] strings = null;
        if (StringUtils.indexOf(language,"-") != -1) {
            strings = language.split("-");
        }
        if (StringUtils.indexOf(language,"_") != -1) {
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        if (InternationalResource.applicationContext == null) {
            InternationalResource.applicationContext = applicationContext;
        }
    }
