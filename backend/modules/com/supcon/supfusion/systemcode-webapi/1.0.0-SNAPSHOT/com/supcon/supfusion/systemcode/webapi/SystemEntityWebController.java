...
import com.supcon.supfusion.systemcode.webapi.vo.SystemEntityAddVO;
import com.supcon.supfusion.systemcode.webapi.vo.SystemEntityResultVO;
import com.supcon.supfusion.systemcode.webapi.vo.SystemEntityUpdateVO;
...
public class SystemEntityWebController extends BaseController {
    ...
    public PageResult<SystemEntityResultVO> queryEntities(String keyword, String moduleId, @Min(value = 1, message = "systemCode.CURRENT_PAGE_MIN_1") @RequestParam("current") Integer current,
        ...
        List<SystemEntityResultVO> voList = new ArrayList<>(systemEntityPageResult.getList().size());
        systemEntityPageResult.getList().stream().forEach(po -> {
            SystemEntityResultVO vo = new SystemEntityResultVO();
