package com.supcon.supfusion.notification.apiserver.dao.config;
...
import com.supcon.supfusion.notification.sharding.handle.NoticeTaskITableNameHandler;
...
@Configuration("apiserverMybatisPlusConfig")
@ConditionalOnMissingBean(name = {"adminMybatisPlusConfig", "engineMybatisPlusConfig"})
@Slf4j
public class MybatisPlusConfig {
    ...
    public PaginationInterceptor paginationInterceptor() {
        log.info("开始初始化PaginationInterceptor");
        ...
        tableNameHandlerMap.put(NoticeTask.getTableName().toLowerCase(), new NoticeTaskITableNameHandler());
