 ...
 * 2021-04-07T09:07:38.554+08:00
 * Generated source version: 3.4.3
 */
@WebServiceClient(name = "WebService",
        wsdlLocation = "http://218.65.241.103:9088/services/WebServiceSoap?wsdl",
        targetNamespace = "http://www.139130.net")
public class WebService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.139130.net", "WebService");
    public final static QName WebServiceSoap = new QName("http://www.139130.net", "WebServiceSoap");
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WebService.class.getName())
                    .log(java.util.logging.Level.INFO,
                            "Can not initialize the default wsdl from {0}", "http://218.65.241.103:9088/services/WebServiceSoap?wsdl");
        }
        WSDL_LOCATION = url;
    }
