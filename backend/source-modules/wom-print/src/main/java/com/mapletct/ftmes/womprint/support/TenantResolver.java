package com.mapletct.ftmes.womprint.support;
...
public class TenantResolver {
    ...
    public TenantResolver(
            @Value("${wom-print.default-tenant:default}") String defaultTenant,
    ...
    private String tenantFromJwt(String authorization) {
        ...
        try {
            ...
            // Authentication is enforced upstream; malformed metadata uses the configured tenant.
        }
        return "";
    }
