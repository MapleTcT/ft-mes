...
SCAN_GLOBS = {
    ...
    "backend/source-modules/**/*.java",
    "backend/source-modules/**/*.md",
    "backend/source-modules/**/*.xml",
    "backend/source-modules/**/*.yml",
    "backend/source-modules/**/Dockerfile",
    ...
    "deploy/bpi-streaming/**/*.example",
    "deploy/bpi-streaming/**/*.md",
    "deploy/bpi-streaming/**/*.sh",
    "deploy/bpi-streaming/**/*.yml",
    ...
    "docs/**/*.md",
    "frontend/apps/bpi/*.html",
    "frontend/apps/bpi/*.json",
    "frontend/apps/bpi/*.md",
    "frontend/apps/bpi/*.ts",
    "frontend/apps/bpi/src/*.css",
    "frontend/apps/bpi/src/*.ts",
    "frontend/apps/bpi/tests/*.cjs",
    "metadata/*.json",
    "metadata/*.png",
    "scripts/*.py",
    "services/**/*.java",
