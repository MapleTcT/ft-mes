...
REQUIRED_FILES = [
    ...
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/application/OverviewService.java",
    ...
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/domain/LineEvidenceCheck.java",
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/domain/LineIncidentSnapshot.java",
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/domain/LineLiveEvidence.java",
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/domain/LineState.java",
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/domain/LineTelemetrySample.java",
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/domain/LineTelemetryState.java",
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/infrastructure/overview/BpiOverviewProperties.java",
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/infrastructure/postgres/BpiPostgresRepository.java",
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/infrastructure/postgres/OverviewPostgresRepository.java",
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/infrastructure/telemetry/TelemetryPostgresRepository.java",
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/infrastructure/postgres/IdempotencyRecord.java",
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/interfaces/rest/OverviewController.java",
    ...
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/domain/ShadowRunSourceCoverage.java",
    "services/bpi-service/app/src/main/java/com/mapletct/ftmes/bpi/domain/ShadowRunTrainingDataCoverage.java",
...
def main() -> int:
    ...
    require_text(
        ...
        [
            ...
            "trainingDataCoverageUsesDistinctActiveBatchesAndUtcProductionDates",
            "UNRESOLVED_CRITICAL_DATA_QUALITY",
            'jsonPath("$.data.metrics.boundaryAgreement").value(0.95)',
            'jsonPath("$.data.trainingDataCoverage.thresholdsMet").value(true)',
