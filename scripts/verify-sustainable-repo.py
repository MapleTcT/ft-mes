...
REQUIRED_PATHS = [
    ...
    "contracts/bpi-events/README.md",
    "contracts/bpi-events/src/main/proto/bpi_events_v1.proto",
    "contracts/bpi-events/src/test/resources/compatibility/bpi-events-v1.fields",
    "contracts/bpi-api/README.md",
    "contracts/bpi-api/openapi.json",
    "contracts/bpi-api/asyncapi.json",
    "contracts/bpi-api/simulation-profile.json",
    ...
    "services/bpi-dataset-materializer/Dockerfile",
    "services/bpi-dataset-materializer/pyproject.toml",
    "services/bpi-dataset-materializer/requirements.runtime.txt",
    "services/bpi-dataset-materializer/src/bpi_dataset_materializer/object_store.py",
    "services/bpi-dataset-materializer/src/bpi_dataset_materializer/parquet.py",
    "services/bpi-dataset-materializer/src/bpi_dataset_materializer/worker.py",
    "services/bpi-dataset-materializer/tests/test_object_store.py",
    "services/bpi-dataset-materializer/tests/test_parquet.py",
    "services/bpi-dataset-catalog-publisher/Dockerfile",
    "services/bpi-dataset-catalog-publisher/README.md",
    "services/bpi-dataset-catalog-publisher/pyproject.toml",
    ...
    "backend/source-modules/batch-intelligence-adapter/pom.xml",
    "backend/source-modules/batch-intelligence-adapter/Dockerfile",
    "backend/source-modules/batch-intelligence-adapter/src/main/java/com/mapletct/ftmes/bpiadapter/BpiProxyController.java",
    "backend/source-modules/batch-intelligence-adapter/src/main/java/com/mapletct/ftmes/bpiadapter/BpiShellMenuController.java",
    ...
    "backend/source-modules/batch-intelligence-adapter/src/test/java/com/mapletct/ftmes/bpiadapter/BpiShellMenuControllerTest.java",
    "deploy/pom.xml",
    ...
    "deploy/minio/bootstrap-bpi-mlflow-artifact-bucket.sh",
    "deploy/minio/bpi-mlflow-artifact-policy.json",
    ...
    "services/bpi-dataset-mlflow-registrar/Dockerfile",
    "services/bpi-dataset-mlflow-registrar/README.md",
    "services/bpi-dataset-mlflow-registrar/pyproject.toml",
    "services/bpi-dataset-mlflow-registrar/src/bpi_dataset_mlflow_registrar/mlflow_client.py",
    "services/bpi-dataset-mlflow-registrar/src/bpi_dataset_mlflow_registrar/repository.py",
    "services/bpi-dataset-mlflow-registrar/src/bpi_dataset_mlflow_registrar/worker.py",
    "services/bpi-mlflow/Dockerfile",
    "services/bpi-mlflow/start-mlflow.sh",
    ...
    "deploy/polaris/test_metastore_bootstrap_gate.py",
    "deploy/polaris/test_bootstrap_bpi_catalog.py",
    ...
    "docs/api/bpi-api-catalog.md",
    "docs/plans/2026-07-22-bpi-phase3b-iceberg-catalog-design.md",
    "docs/plans/2026-07-22-bpi-phase3c-mlflow-dataset-registration-design.md",
    ...
    "docs/backend-table-audit/bpi-iot-replay-runtime-acceptance.md",
    ...
    "docs/testing/bpi-shell-menu-gate-acceptance.md",
    "docs/testing/bpi-live-mqtt-wom-start-end-acceptance.md",
    ...
    "docs/product/ft-mes-modular-product-portfolio.md",
    "docs/product/ft-mes-lean-standard-product-manual.md",
    "docs/product/ft-mes-capability-rationalization.md",
    "docs/decisions/0001-modular-product-line-architecture.md",
    ...
    "metadata/bpi-iot-replay-runtime-acceptance.json",
    ...
    "metadata/bpi-shell-menu-gate-final.png",
    "metadata/bpi-shell-menu-gate-feature-flag.png",
    "metadata/bpi-shell-menu-gate-mobile.png",
    "metadata/bpi-live-mqtt-wom-start-end-acceptance.json",
    ...
    "metadata/bpi-formal-identity-force-close-acceptance.json",
    "metadata/bpi-formal-identity-force-close-pending.png",
    "metadata/bpi-formal-identity-force-close-completed.png",
    "deploy/docker/scripts/adp-bpi-formal-identity-force-close-acceptance.js",
    ...
    "scripts/verify-bpi-api-contracts.py",
    "scripts/verify-bpi-service.py",
    "scripts/verify-bpi-streaming.py",
    "scripts/verify-bpi-stream-deployment.py",
    "scripts/verify-bpi-ui.py",
    "scripts/verify-bpi-adapter.py",
    "scripts/verify-bpi-shell-menu-gate.py",
    "simulation/bpi/README.md",
    "simulation/bpi/scenario.js",
    ...
    "deploy/docker/scripts/adp-patrol-report-smoke.js",
