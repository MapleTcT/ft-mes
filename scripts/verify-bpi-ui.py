...
def main() -> int:
    ...
    if not failures:
        ...
        for required in ("console", "pageerror", "requestfailed", "/tmp/bpi-console-desktop.png", "/tmp/bpi-console-candidate-rejected.png", "/tmp/bpi-console-batch-lifecycle.png", "/tmp/bpi-console-end-boundary.png", "/tmp/bpi-console-point-calibration-governance.png", "/tmp/bpi-console-rule-published.png", "/tmp/bpi-console-rule-application-applied.png", "/tmp/bpi-console-rule-publication-blocked.png", "CLOSED_RAW", "END_BOUNDARY_CONFIRMED", "sourceCalibrationStatus", "calibrationEvidenceId", "REVOKED", "rule-runtime-readiness", "DEGRADED", "runtimeReadinessStatus", "document.documentElement.scrollWidth"):
