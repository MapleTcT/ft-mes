...
acceptance-systemcode-persistence:
	ADP_BASE_URL=$(ADP_BASE_URL) ADP_USERNAME=$(ADP_USERNAME) ADP_PASSWORD=$(ADP_PASSWORD) ADP_SYSTEMCODE_PERSISTENCE_OUTPUT=$(SYSTEMCODE_PERSISTENCE_OUTPUT) $(NODE) deploy/docker/scripts/adp-systemcode-persistence-acceptance.js
