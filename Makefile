...
.PHONY: product-portfolio-matrix-check
...
help:
	...
	@printf '%s\n' '  make product-portfolio-matrix-check Validate modular products, dependencies and bundles'
	@printf '%s\n' '  make product-capability-rationalization-check Validate lean-product decisions and links'
...
product-portfolio-matrix-check:
	$(PYTHON) scripts/verify-product-portfolio-matrix.py

product-capability-rationalization-check:
	$(PYTHON) scripts/verify-product-capability-rationalization.py
