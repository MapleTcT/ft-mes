...
const routes = [
  {
    ...
    component: dynamicRoute({
      component: () => import('./routes/groupManage')
    })
  },
  {
    path: '/company',
  ...
  },
  {
    ...
    name: 'personmanage',
    component: dynamicRoute({
      component: () => import('./routes/personManage')
    })
  },
  {
  ...
  },
  {
    path: '/reference',
    component: dynamicRoute({
      component: () => import('./routes/reference')
    })
  },
  {
    path: '/referenceForTest',
    component: dynamicRoute({
      component: () => import('./routes/referenceForTest')
    })
  }
];
