...
class HealthState:
    ...
    active_materialization_id: str | None = None
    ...
    def snapshot(self) -> dict[str, Any]:
        with self._lock:
            return {
                "service": "bpi-dataset-materializer",
                "enabled": self.enabled,
                "status": self.status,
                "lastCycleAt": self.last_cycle_at,
                "lastSuccessAt": self.last_success_at,
                "lastError": self.last_error,
                "activeMaterializationId": self.active_materialization_id,
            }
